...
import gob.inei.renadef2016.fragments.ReporteFragment_002;
import gob.inei.renadef2016.fragments.ReporteFragment_001;
...
public class ReportesFragmentActivity extends MasterActivity implements ActionBar.TabListener, Respondible {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		drawerToggle = new ActionBarDrawerToggle(this, drawerLayout,
			...
			public void onDrawerClosed(View view) {
				...
				ActivityCompat.invalidateOptionsMenu(ReportesFragmentActivity.this);
			}
    ...
    private List<FragmentForm> createFragments() {
		...
		/*0*/ fragments.add(new ReporteFragment_001());
		/*0*/ fragments.add(new ReporteFragment_002());	
		return fragments;
	}
	...
	private class ExportacionRuralSimpleOnPageChangeListener extends FragmentViewPager.SimpleOnPageChangeListener {		
		...
		public void onPageScrollStateChanged(int state) {
			if (state == ViewPager.SCROLL_STATE_DRAGGING) {
				ReportesFragmentActivity.this.setPrevPage(viewPager.getCurrentItem());
				esArrastre = true;
			}
		...
		public void onPageSelected(int position) {
    		ReportesFragmentActivity.this.setCurPage(position);
//    		if (position > MARCO) {
//    			esArrastre = false;
//    			nextFragment(ReportesFragmentActivity.this.getPrevPage());
//    			return;
//			}    		
    		boolean flag = false;
    		if (ReportesFragmentActivity.this.getPrevPage() < ReportesFragmentActivity.this.getCurPage()) {
        		flag = ReportesFragmentActivity.this.pageAdapter.getItem(ReportesFragmentActivity.this.getPrevPage()).grabar();
        		if (!flag) {
        			esArrastre = false;
        			nextFragment(ReportesFragmentActivity.this.getPrevPage());
        			return;
    		...
    		if (esArrastre) {
        		ReportesFragmentActivity.this.pageAdapter.getItem(ReportesFragmentActivity.this.getCurPage()).cargarDatos();
			}
    		esSalto = false;    		
    	}
	}
