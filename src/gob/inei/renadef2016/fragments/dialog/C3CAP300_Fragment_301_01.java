...
//			}
		...
		//  Validación para DNI	
				...
				mensaje="Si Preg.302 es DNI entonces el n\u00famero es a 8 dígitos";
				view = txtIVH302_N;
				error=true;
				return false;					
			}
...
//				mensaje="Si Preg.302 es Carnet de Extranjería o Pasaporte entonces el n\u00famero es a 12 dígitos";
				mensaje="Si Preg.302 es Carnet de extranjería o Pasaporte entonces el n\u00famero debe estar entre 6 a 12 dígitos";
				view = txtIVH302_N;
				error=true;
				return false;
			}
			...
			// Preguntar a alex		
	//		//		Si IVH302 = 4 & (IVH302_N  NO INICIA CON UNA LETRA) Þ Error
	...
	//		Si IVH302 = 4 & (IVH302_N  NO TERMINA CON 8 NUMEROS) Þ Error      -1,9
...
//				}
		...
		if(rgIVH303.getTagSelected()==null){
			...
			mensaje ="Las características de la edad no se relacionan con tipo de documento.";		
			view = rgIVH304;
			error=true;
			return false;			
		}
